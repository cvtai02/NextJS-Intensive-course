...
export default function AudioPostPage() {
  // Get an audio post article
  const article = articles.find((a) => a.postFormat === 'audio') || articles[0];
            ...
            <article className="format-audio">
              <div className="content-media">
                <div className="post-thumb">
                  <img src="/images/thumbs/single/single-02.jpg" alt="Audio Post" />
                </div>
                <div className="audio-wrap">
                  <audio
                    id="player2"
                    src={article.audioUrl || '/media/AirReview-Landmarks-02-ChasingCorporate.mp3'}
                    controls
                  ></audio>
                </div>
              </div>
   ...
   border-radius: 3px;
              ...
              <div className="pagenav group">
                <div className="prev-nav">
                  <Link href="/blog/standard" rel="prev">
                    <span>Previous</span>
                    Standard Format Post
                  </Link>
                </div>
                <div className="next-nav">
                  <Link href="/blog/video" rel="next">
                    <span>Next</span>
                    Video Format Post
                  </Link>
                </div>
