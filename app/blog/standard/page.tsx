...
export default function StandardPostPage() {
  // Get a standard post article
  const article = articles.find((a) => a.postFormat === 'standard') || articles[0];
            ...
            <article className="format-standard">
              <div className="content-media">
                <div className="post-thumb">
                  <img src="/images/thumbs/single/single-01.jpg" alt="Standard Post" />
                </div>
              </div>
   ...
   border-radius: 3px;
              ...
              <div className="pagenav group">
                <div className="prev-nav">
                  <Link href="/blog/gallery" rel="prev">
                    <span>Previous</span>
                    Gallery Format Post
                  </Link>
                </div>
                <div className="next-nav">
                  <Link href="/blog/audio" rel="next">
                    <span>Next</span>
                    Audio Format Post
                  </Link>
                </div>
